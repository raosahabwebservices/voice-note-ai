...
import { Mic, Upload, FileText, LayoutDashboard, BookOpen, Sparkles, Zap, ShieldAlert, LogOut, Calendar, Building2, Crown } from 'lucide-react';
          ...
          <button
            ...
            className={`flex items-center space-x-1.5 px-3 py-2 rounded-lg text-xs font-medium transition-all ${
              activeTab === 'study_planner'
                ...
                : 'text-purple-700 hover:text-slate-900 hover:bg-white/60'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-1.5 px-3 py-2 rounded-lg text-xs font-medium transition-all ${
              activeTab === ('coaching' as any)
                ? 'bg-blue-600 text-white shadow-sm'
                : 'text-blue-700 hover:text-slate-900 hover:bg-white/60'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-1.5 px-3 py-2 rounded-lg text-xs font-medium transition-all ${
              activeTab === ('subscription' as any)
                ...
                : 'text-emerald-700 hover:text-slate-900 hover:bg-white/60'
            }`}
          >
