...
export const UploadAudioView: React.FC<UploadAudioViewProps> = ({
  ...
  const [lectureDurationMinutes, setLectureDurationMinutes] = useState<number>(30);
      ...
      if (inputType === 'text') {
        ...
        const response = await fetch('/api/jobs/create', {
          ...
          body: JSON.stringify({
            ...
            durationSeconds: lectureDurationMinutes * 60,
        ...
        {!isProcessing && (
          <div className="space-y-6">
            ...
            <div className="space-y-4 pt-4 border-t border-slate-200">
              {/* 30s Speed Guarantee Banner */}
              <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200 flex items-center space-x-3 text-amber-900 shadow-sm">
                <span className="text-2xl">⚡</span>
                <div>
                  <p className="font-bold text-xs uppercase tracking-wider text-amber-800">Lightning Fast AI Processing</p>
                  <p className="text-sm font-extrabold text-slate-900">Lecture 1 min ka ho ya 60 min ka, AI summary & answers sirf 30 sec me!</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  placeholder="e.g. Physics Chapter 3 Lecture"
                  value={customTitle}
